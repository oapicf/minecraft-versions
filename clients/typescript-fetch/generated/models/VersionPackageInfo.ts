...
import {
    ...
    VersionPackageInfoDownloadsToJSONTyped,
...
import {
    ...
    VersionPackageInfoAssetIndexToJSONTyped,
...
import {
    ...
    VersionPackageInfoJavaVersionToJSONTyped,
...
export function VersionPackageInfoToJSON(json: any): VersionPackageInfo {
    return VersionPackageInfoToJSONTyped(json, false);
}

export function VersionPackageInfoToJSONTyped(value?: VersionPackageInfo | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'releaseTime': value['releaseTime'] == null ? value['releaseTime'] : value['releaseTime'].toISOString(),
        'type': value['type'],
    };
}
