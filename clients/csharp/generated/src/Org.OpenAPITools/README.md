...
additionalProperties:
  packageGuid: '{FB940814-3714-4FDB-8C02-A30B3CC78298}'
...
namespace YourProject
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            IGetMinecraftVersionManifestApiResponse apiResponse = await api.GetMinecraftVersionManifestAsync("todo");
