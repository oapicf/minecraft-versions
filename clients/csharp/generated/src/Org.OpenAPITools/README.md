...
java -jar "<path>/openapi-generator/modules/openapi-generator-cli/target/openapi-generator-cli.jar" generate `
    ...
    --git-host "github.com" `
    --git-repo-id "minecraft-versions" `
    --git-user-id "oapicf" `
...
namespace YourProject
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            GetMinecraftVersionManifestApiResponse apiResponse = await api.GetMinecraftVersionManifestAsync("todo");
            VersionManifest model = apiResponse.Ok();
        }
...
- packageCopyright: No Copyright
- packageDescription: A library generated from a OpenAPI doc
- packageGuid: {72391331-F672-4734-B196-7CEB786BBB8D}
- packageName: Org.OpenAPITools
- packageTags: 
- packageTitle: OpenAPI Library
- packageVersion: 1.0.0
