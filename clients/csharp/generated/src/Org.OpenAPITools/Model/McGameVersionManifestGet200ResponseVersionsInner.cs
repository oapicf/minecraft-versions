...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_mc_game_version_manifest_get_200_response_versions_inner")]
    public partial class McGameVersionManifestGet200ResponseVersionsInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="McGameVersionManifestGet200ResponseVersionsInner" /> class.
        /// </summary>
        ...
        public McGameVersionManifestGet200ResponseVersionsInner(string id = default(string), string type = default(string), string url = default(string), DateTime time = default(DateTime), DateTime releaseTime = default(DateTime))
        {
            this.Id = id;
            this.Type = type;
            this.Url = url;
