...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class VersionManifestLatest : IValidatableObject
    {
        ...
        public string? Release { get { return this.ReleaseOption.Value; } set { this.ReleaseOption = new(value); } }
        ...
        public string? Snapshot { get { return this.SnapshotOption.Value; } set { this.SnapshotOption = new(value); } }
    ...
    /// </summary>
    public partial class VersionManifestLatestJsonConverter : JsonConverter<VersionManifestLatest>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="VersionManifestLatestJsonConverter" /> class.
        /// </summary>
        public VersionManifestLatestJsonConverter()
        {
            OnCreated();
        }
