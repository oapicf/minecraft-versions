...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "VersionPackageInfo_downloads")]
    public partial class VersionPackageInfoDownloads : IValidatableObject
    {
        ...
        public VersionPackageInfoDownloads(Download varClient = default(Download), Download clientMappings = default(Download), Download server = default(Download), Download serverMappings = default(Download))
        {
