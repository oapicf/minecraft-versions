...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class VersionPackageInfoDownloads : IValidatableObject
    {
        ...
        public Download? VarClient { get { return this.VarClientOption.Value; } set { this.VarClientOption = new(value); } }
        ...
        public Download? ClientMappings { get { return this.ClientMappingsOption.Value; } set { this.ClientMappingsOption = new(value); } }
        ...
        public Download? Server { get { return this.ServerOption.Value; } set { this.ServerOption = new(value); } }
        ...
        public Download? ServerMappings { get { return this.ServerMappingsOption.Value; } set { this.ServerMappingsOption = new(value); } }
    ...
    /// </summary>
    public partial class VersionPackageInfoDownloadsJsonConverter : JsonConverter<VersionPackageInfoDownloads>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="VersionPackageInfoDownloadsJsonConverter" /> class.
        /// </summary>
        public VersionPackageInfoDownloadsJsonConverter()
        {
            OnCreated();
        }
