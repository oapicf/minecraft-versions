...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class VersionPackageInfoAssetIndex : IValidatableObject
    {
        ...
        public int? TotalSize { get { return this.TotalSizeOption.Value; } set { this.TotalSizeOption = new(value); } }
    ...
    /// </summary>
    public partial class VersionPackageInfoAssetIndexJsonConverter : JsonConverter<VersionPackageInfoAssetIndex>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="VersionPackageInfoAssetIndexJsonConverter" /> class.
        /// </summary>
        public VersionPackageInfoAssetIndexJsonConverter()
        {
            OnCreated();
        }
