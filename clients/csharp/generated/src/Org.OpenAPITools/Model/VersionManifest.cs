...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class VersionManifest : IValidatableObject
    {
        ...
        public VersionManifestLatest? Latest { get { return this.LatestOption.Value; } set { this.LatestOption = new(value); } }
        ...
        public List<ModelVersion>? Versions { get { return this.VersionsOption.Value; } set { this.VersionsOption = new(value); } }
    ...
    /// </summary>
    public partial class VersionManifestJsonConverter : JsonConverter<VersionManifest>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="VersionManifestJsonConverter" /> class.
        /// </summary>
        public VersionManifestJsonConverter()
        {
            OnCreated();
        }
