...
namespace Org.OpenAPITools.Model
{
    ...
    /// VersionManifest
    /// </summary>
    [DataContract(Name = "VersionManifest")]
    public partial class VersionManifest : IValidatableObject
    {
        ...
        public VersionManifest(VersionManifestLatest latest = default(VersionManifestLatest), List<ModelVersion> versions = default(List<ModelVersion>))
        {
            this.Latest = latest;
