...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class VersionPackageInfo : IValidatableObject
    {
        ...
        public VersionPackageInfoAssetIndex? AssetIndex { get { return this.AssetIndexOption.Value; } set { this.AssetIndexOption = new(value); } }
        ...
        public string? Assets { get { return this.AssetsOption.Value; } set { this.AssetsOption = new(value); } }
        ...
        public int? ComplianceLevel { get { return this.ComplianceLevelOption.Value; } set { this.ComplianceLevelOption = new(value); } }
        ...
        public VersionPackageInfoDownloads? Downloads { get { return this.DownloadsOption.Value; } set { this.DownloadsOption = new(value); } }
        ...
        public VersionPackageInfoJavaVersion? JavaVersion { get { return this.JavaVersionOption.Value; } set { this.JavaVersionOption = new(value); } }
        ...
        public string? MainClass { get { return this.MainClassOption.Value; } set { this.MainClassOption = new(value); } }
        ...
        public int? MinimumLauncherVersion { get { return this.MinimumLauncherVersionOption.Value; } set { this.MinimumLauncherVersionOption = new(value); } }
        ...
        /// Gets or Sets Time
        /// </summary>
        /* <example>2024-04-01T11:14:41.000+00:00</example> */
        ...
        /// </summary>
        /* <example>2024-04-01T11:07:19.000+00:00</example> */
        [JsonPropertyName("releaseTime")]
        public DateTime? ReleaseTime { get { return this.ReleaseTimeOption.Value; } set { this.ReleaseTimeOption = new(value); } }
    ...
    /// </summary>
    public partial class VersionPackageInfoJsonConverter : JsonConverter<VersionPackageInfo>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="VersionPackageInfoJsonConverter" /> class.
        /// </summary>
        public VersionPackageInfoJsonConverter()
        {
            OnCreated();
        }
        ...
        /// </summary>
        public string ReleaseTimeFormat { get; private set; } = "yyyy'-'MM'-'dd'T'HH':'mm':'ss'.'fffffffK";
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "complianceLevel":
                            complianceLevel = new Option<int?>(utf8JsonReader.TokenType == JsonTokenType.Null ? (int?)null : utf8JsonReader.GetInt32());
                            break;
                        case "downloads":
                        ...
                        case "minimumLauncherVersion":
                            minimumLauncherVersion = new Option<int?>(utf8JsonReader.TokenType == JsonTokenType.Null ? (int?)null : utf8JsonReader.GetInt32());
                            break;
                        case "time":
