...
from app.openapi_server.models.v1_packages_package_id_version_id_json_get200_response_downloads_client import V1PackagesPackageIdVersionIdJsonGet200ResponseDownloadsClient  # noqa: F401,E501
...
class V1PackagesPackageIdVersionIdJsonGet200ResponseDownloads(Model):
    ...
    def __init__(self, client: V1PackagesPackageIdVersionIdJsonGet200ResponseDownloadsClient=None, client_mappings: V1PackagesPackageIdVersionIdJsonGet200ResponseDownloadsClient=None, server: V1PackagesPackageIdVersionIdJsonGet200ResponseDownloadsClient=None, server_mappings: V1PackagesPackageIdVersionIdJsonGet200ResponseDownloadsClient=None):  # noqa: E501
        """V1PackagesPackageIdVersionIdJsonGet200ResponseDownloads - a model defined in Swagger

        :param client: The client of this V1PackagesPackageIdVersionIdJsonGet200ResponseDownloads.  # noqa: E501
        :type client: V1PackagesPackageIdVersionIdJsonGet200ResponseDownloadsClient
        :param client_mappings: The client_mappings of this V1PackagesPackageIdVersionIdJsonGet200ResponseDownloads.  # noqa: E501
        :type client_mappings: V1PackagesPackageIdVersionIdJsonGet200ResponseDownloadsClient
        :param server: The server of this V1PackagesPackageIdVersionIdJsonGet200ResponseDownloads.  # noqa: E501
        :type server: V1PackagesPackageIdVersionIdJsonGet200ResponseDownloadsClient
        :param server_mappings: The server_mappings of this V1PackagesPackageIdVersionIdJsonGet200ResponseDownloads.  # noqa: E501
    ...
    @classmethod
    def from_dict(cls, dikt) -> 'V1PackagesPackageIdVersionIdJsonGet200ResponseDownloads':
        """Returns the dict as a model

        :param dikt: A dict.
        :type: dict
        :return: The _v1_packages__packageId___versionId__json_get_200_response_downloads of this V1PackagesPackageIdVersionIdJsonGet200ResponseDownloads.  # noqa: E501
        :rtype: V1PackagesPackageIdVersionIdJsonGet200ResponseDownloads
        """
        return util.deserialize_model(dikt, cls)

    @property
    def client(self) -> V1PackagesPackageIdVersionIdJsonGet200ResponseDownloadsClient:
    ...
    @client.setter
    def client(self, client: V1PackagesPackageIdVersionIdJsonGet200ResponseDownloadsClient):
    ...
    @property
    def client_mappings(self) -> V1PackagesPackageIdVersionIdJsonGet200ResponseDownloadsClient:
    ...
    def client_mappings(self, client_mappings: V1PackagesPackageIdVersionIdJsonGet200ResponseDownloadsClient):
    ...
    @property
    def server(self) -> V1PackagesPackageIdVersionIdJsonGet200ResponseDownloadsClient:
    ...
    @server.setter
    def server(self, server: V1PackagesPackageIdVersionIdJsonGet200ResponseDownloadsClient):
    ...
    @property
    def server_mappings(self) -> V1PackagesPackageIdVersionIdJsonGet200ResponseDownloadsClient:
    ...
    def server_mappings(self, server_mappings: V1PackagesPackageIdVersionIdJsonGet200ResponseDownloadsClient):
