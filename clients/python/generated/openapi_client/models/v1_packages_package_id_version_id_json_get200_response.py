...
class V1PackagesPackageIdVersionIdJsonGet200Response(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "assetIndex": V1PackagesPackageIdVersionIdJsonGet200ResponseAssetIndex.from_dict(obj["assetIndex"]) if obj.get("assetIndex") is not None else None,
            "assets": obj.get("assets"),
            "complianceLevel": obj.get("complianceLevel"),
            "downloads": V1PackagesPackageIdVersionIdJsonGet200ResponseDownloads.from_dict(obj["downloads"]) if obj.get("downloads") is not None else None,
            "id": obj.get("id"),
            "javaVersion": V1PackagesPackageIdVersionIdJsonGet200ResponseJavaVersion.from_dict(obj["javaVersion"]) if obj.get("javaVersion") is not None else None,
