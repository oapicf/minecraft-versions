...
class McGameVersionManifestGet200Response(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "latest": McGameVersionManifestGet200ResponseLatest.from_dict(obj["latest"]) if obj.get("latest") is not None else None,
            "versions": [McGameVersionManifestGet200ResponseVersionsInner.from_dict(_item) for _item in obj["versions"]] if obj.get("versions") is not None else None
        })
        return _obj
