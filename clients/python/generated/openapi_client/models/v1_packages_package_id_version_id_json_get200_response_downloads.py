...
class V1PackagesPackageIdVersionIdJsonGet200ResponseDownloads(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "client": V1PackagesPackageIdVersionIdJsonGet200ResponseDownloadsClient.from_dict(obj["client"]) if obj.get("client") is not None else None,
            "client_mappings": V1PackagesPackageIdVersionIdJsonGet200ResponseDownloadsClient.from_dict(obj["client_mappings"]) if obj.get("client_mappings") is not None else None,
            "server": V1PackagesPackageIdVersionIdJsonGet200ResponseDownloadsClient.from_dict(obj["server"]) if obj.get("server") is not None else None,
            "server_mappings": V1PackagesPackageIdVersionIdJsonGet200ResponseDownloadsClient.from_dict(obj["server_mappings"]) if obj.get("server_mappings") is not None else None
        })
        return _obj
