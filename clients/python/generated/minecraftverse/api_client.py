...
from minecraftverse.api_response import ApiResponse, T as ApiResponseT
import minecraftverse.models
from minecraftverse import rest
from minecraftverse.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
...
class ApiClient:
    ...
    def __init__(
        ...
        self.user_agent = 'OpenAPI-Generator/1.3.5-pre.0/python'
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(minecraftverse.models, klass)
