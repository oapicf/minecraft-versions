...
public interface V1Api {
    ...
    default ResponseEntity<VersionPackageInfo> getMinecraftVersionPackageInfo(
        @NotNull @Parameter(name = "packageId", description = "", required = true, in = ParameterIn.PATH) @PathVariable("packageId") String packageId,
        @NotNull @Parameter(name = "versionId", description = "", required = true, in = ParameterIn.PATH) @PathVariable("versionId") String versionId
    ) {
