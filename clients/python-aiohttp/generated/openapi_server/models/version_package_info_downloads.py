...
class VersionPackageInfoDownloads(Model):
    ...
    def __init__(self, client: Download=None, client_mappings: Download=None, server: Download=None, server_mappings: Download=None):
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'VersionPackageInfoDownloads':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The VersionPackageInfo_downloads of this VersionPackageInfoDownloads.
        """
