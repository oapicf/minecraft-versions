...
std::string _v1_packages__packageId___versionId__json_get_200_response::toJsonString(bool prettyJson /* = false */) const
{
	std::stringstream ss;
...
ptree _v1_packages__packageId___versionId__json_get_200_response::toPropertyTree() const
{
	ptree pt;
	ptree tmp_node;
...
void _v1_packages__packageId___versionId__json_get_200_response::fromPropertyTree(ptree const &pt)
{
	ptree tmp_node;
	m_Version = pt.get("version", "");
	if (pt.get_child_optional("assetIndex")) {
        m_AssetIndex = fromPt<_v1_packages__packageId___versionId__json_get_200_response_assetIndex>(pt.get_child("assetIndex"));
	}
	m_Assets = pt.get("assets", 0);
	m_ComplianceLevel = pt.get("complianceLevel", 0);
	if (pt.get_child_optional("downloads")) {
        m_Downloads = fromPt<_v1_packages__packageId___versionId__json_get_200_response_downloads>(pt.get_child("downloads"));
	}
	m_Id = pt.get("id", "");
	if (pt.get_child_optional("javaVersion")) {
        m_JavaVersion = fromPt<_v1_packages__packageId___versionId__json_get_200_response_javaVersion>(pt.get_child("javaVersion"));
	}
...
_v1_packages__packageId___versionId__json_get_200_response_assetIndex _v1_packages__packageId___versionId__json_get_200_response::getAssetIndex() const
{
    return m_AssetIndex;
}

void _v1_packages__packageId___versionId__json_get_200_response::setAssetIndex(_v1_packages__packageId___versionId__json_get_200_response_assetIndex value)
{
    m_AssetIndex = value;
}
...
_v1_packages__packageId___versionId__json_get_200_response_downloads _v1_packages__packageId___versionId__json_get_200_response::getDownloads() const
{
    return m_Downloads;
}

void _v1_packages__packageId___versionId__json_get_200_response::setDownloads(_v1_packages__packageId___versionId__json_get_200_response_downloads value)
{
    m_Downloads = value;
}
...
_v1_packages__packageId___versionId__json_get_200_response_javaVersion _v1_packages__packageId___versionId__json_get_200_response::getJavaVersion() const
{
    return m_JavaVersion;
}

void _v1_packages__packageId___versionId__json_get_200_response::setJavaVersion(_v1_packages__packageId___versionId__json_get_200_response_javaVersion value)
{
    m_JavaVersion = value;
}
