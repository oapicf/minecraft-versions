...
std::string _v1_packages__packageId___versionId__json_get_200_response_assetIndex::toJsonString(bool prettyJson /* = false */) const
{
	std::stringstream ss;
...
ptree _v1_packages__packageId___versionId__json_get_200_response_assetIndex::toPropertyTree() const
{
	ptree pt;
	ptree tmp_node;
	pt.put("id", m_Id);
...
void _v1_packages__packageId___versionId__json_get_200_response_assetIndex::fromPropertyTree(ptree const &pt)
{
	ptree tmp_node;
	m_Id = pt.get("id", "");
	m_Sha1 = pt.get("sha1", "");
