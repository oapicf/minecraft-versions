...
std::string _v1_packages__packageId___versionId__json_get_200_response_javaVersion::toJsonString(bool prettyJson /* = false */) const
{
	std::stringstream ss;
...
ptree _v1_packages__packageId___versionId__json_get_200_response_javaVersion::toPropertyTree() const
{
	ptree pt;
	ptree tmp_node;
...
void _v1_packages__packageId___versionId__json_get_200_response_javaVersion::fromPropertyTree(ptree const &pt)
{
	ptree tmp_node;
