...
class VersionPackageInfoDownloads(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VersionPackageInfoDownloads:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VersionPackageInfoDownloads:
        """Create an instance of VersionPackageInfoDownloads from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VersionPackageInfoDownloads.parse_obj(obj)

        _obj = VersionPackageInfoDownloads.parse_obj({
            "client": Download.from_dict(obj.get("client")) if obj.get("client") is not None else None,
            "client_mappings": Download.from_dict(obj.get("client_mappings")) if obj.get("client_mappings") is not None else None,
            "server": Download.from_dict(obj.get("server")) if obj.get("server") is not None else None,
            "server_mappings": Download.from_dict(obj.get("server_mappings")) if obj.get("server_mappings") is not None else None
        })
        return _obj
