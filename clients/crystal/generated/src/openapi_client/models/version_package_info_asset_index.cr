...
module OpenAPIClient
  class VersionPackageInfoAssetIndex
    ...
    @[JSON::Field(key: "sha1", type: String?, nillable: true, emit_null: false)]
    property sha1 : String?

    @[JSON::Field(key: "size", type: Int32?, nillable: true, emit_null: false)]
    property size : Int32?

    @[JSON::Field(key: "totalSize", type: Int32?, nillable: true, emit_null: false)]
    ...
    def to_h
      ...
      hash["id"] = _to_h(id)
      hash["sha1"] = _to_h(sha1)
      hash["size"] = _to_h(size)
      hash["totalSize"] = _to_h(total_size)
      hash["url"] = _to_h(url)
      hash.to_h
    end
