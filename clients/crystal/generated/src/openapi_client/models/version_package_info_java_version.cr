...
module OpenAPIClient
  class VersionPackageInfoJavaVersion
    ...
    # Optional properties
    @[JSON::Field(key: "component", type: String?, nillable: true, emit_null: false)]
    property component : String?

    @[JSON::Field(key: "majorVersion", type: Int32?, nillable: true, emit_null: false)]
    ...
    def to_h
      ...
      hash["majorVersion"] = _to_h(major_version)
      hash.to_h
    end
