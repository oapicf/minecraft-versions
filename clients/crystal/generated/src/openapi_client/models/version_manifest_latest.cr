...
module OpenAPIClient
  class VersionManifestLatest
    ...
    # Optional properties
    @[JSON::Field(key: "release", type: String?, nillable: true, emit_null: false)]
    property release : String?

    @[JSON::Field(key: "snapshot", type: String?, nillable: true, emit_null: false)]
    ...
    def to_h
      ...
      hash["release"] = _to_h(release)
      hash["snapshot"] = _to_h(snapshot)
      hash.to_h
    end
