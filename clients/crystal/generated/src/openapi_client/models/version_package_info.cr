...
module OpenAPIClient
  class VersionPackageInfo
    ...
    def initialize(@version : String?, @asset_index : VersionPackageInfoAssetIndex?, @assets : String?, @compliance_level : Int32?, @downloads : VersionPackageInfoDownloads?, @id : String?, @java_version : VersionPackageInfoJavaVersion?, @main_class : String?, @minimum_launcher_version : Int32?, @time : Time?, @release_time : Time?, @_type : String?)
    end
