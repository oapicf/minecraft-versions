...
-- |
data OpenAPIConfig = OpenAPIConfig
...
-- | display the config
instance P.Show OpenAPIConfig where
  show c =
    T.printf
...
-- | constructs a default OpenAPIConfig
--
-- configHost:
--
...
-- @"openapi/0.1.0.0"@
--
newConfig :: IO OpenAPIConfig
newConfig = do
    logCxt <- initLogContext
    return $ OpenAPIConfig
        { configHost = "https://launchermeta.mojang.com"
        , configUserAgent = "openapi/0.1.0.0"
...
addAuthMethod :: AuthMethod auth => OpenAPIConfig -> auth -> OpenAPIConfig
addAuthMethod config@OpenAPIConfig {configAuthMethods = as} a =
  config { configAuthMethods = AnyAuthMethod a : as}

-- | updates the config to use stdout logging
withStdoutLogging :: OpenAPIConfig -> IO OpenAPIConfig
...
withStderrLogging :: OpenAPIConfig -> IO OpenAPIConfig
...
withNoLogging :: OpenAPIConfig -> OpenAPIConfig
...
data OpenAPIRequest req contentType res accept = OpenAPIRequest
  { rMethod  :: NH.Method   -- ^ Method of OpenAPIRequest
  , rUrlPath :: [BCL.ByteString] -- ^ Endpoint of OpenAPIRequest
  , rParams   :: Params -- ^ params of OpenAPIRequest
  , rAuthTypes :: [P.TypeRep] -- ^ types of auth methods
  }
  deriving (P.Show)

-- | 'rMethod' Lens
rMethodL :: Lens_' (OpenAPIRequest req contentType res accept) NH.Method
rMethodL f OpenAPIRequest{..} = (\rMethod -> OpenAPIRequest { rMethod, ..} ) <$> f rMethod
{-# INLINE rMethodL #-}

-- | 'rUrlPath' Lens
rUrlPathL :: Lens_' (OpenAPIRequest req contentType res accept) [BCL.ByteString]
rUrlPathL f OpenAPIRequest{..} = (\rUrlPath -> OpenAPIRequest { rUrlPath, ..} ) <$> f rUrlPath
{-# INLINE rUrlPathL #-}

-- | 'rParams' Lens
rParamsL :: Lens_' (OpenAPIRequest req contentType res accept) Params
rParamsL f OpenAPIRequest{..} = (\rParams -> OpenAPIRequest { rParams, ..} ) <$> f rParams
{-# INLINE rParamsL #-}

-- | 'rParams' Lens
rAuthTypesL :: Lens_' (OpenAPIRequest req contentType res accept) [P.TypeRep]
rAuthTypesL f OpenAPIRequest{..} = (\rAuthTypes -> OpenAPIRequest { rAuthTypes, ..} ) <$> f rAuthTypes
{-# INLINE rAuthTypesL #-}
...
class HasBodyParam req param where
  setBodyParam :: forall contentType res accept. (Consumes req contentType, MimeRender contentType param) => OpenAPIRequest req contentType res accept -> param -> OpenAPIRequest req contentType res accept
  setBodyParam req xs =
...
class HasOptionalParam req param where
  ...
  applyOptionalParam :: OpenAPIRequest req contentType res accept -> param -> OpenAPIRequest req contentType res accept
  applyOptionalParam = (-&-)
  {-# INLINE applyOptionalParam #-}

  -- | infix operator \/ alias for 'addOptionalParam'
  (-&-) :: OpenAPIRequest req contentType res accept -> param -> OpenAPIRequest req contentType res accept
  (-&-) = applyOptionalParam
  {-# INLINE (-&-) #-}
...
-- ** OpenAPIRequest Utils

_mkRequest :: NH.Method -- ^ Method
          -> [BCL.ByteString] -- ^ Endpoint
          -> OpenAPIRequest req contentType res accept -- ^ req: Request Type, res: Response Type
_mkRequest m u = OpenAPIRequest m u _mkParams []

_mkParams :: Params
_mkParams = Params [] [] ParamBodyNone

setHeader ::
     OpenAPIRequest req contentType res accept
  -> [NH.Header]
  -> OpenAPIRequest req contentType res accept
...
removeHeader :: OpenAPIRequest req contentType res accept -> [NH.HeaderName] -> OpenAPIRequest req contentType res accept
...
_setContentTypeHeader :: forall req contentType res accept. MimeType contentType => OpenAPIRequest req contentType res accept -> OpenAPIRequest req contentType res accept
_setContentTypeHeader req =
    case mimeType (P.Proxy :: P.Proxy contentType) of
        Just m -> req `setHeader` [("content-type", BC.pack $ P.show m)]
        Nothing -> req `removeHeader` ["content-type"]

_setAcceptHeader :: forall req contentType res accept. MimeType accept => OpenAPIRequest req contentType res accept -> OpenAPIRequest req contentType res accept
...
addForm :: OpenAPIRequest req contentType res accept -> WH.Form -> OpenAPIRequest req contentType res accept
addForm req newform =
...
_addMultiFormPart :: OpenAPIRequest req contentType res accept -> NH.Part -> OpenAPIRequest req contentType res accept
...
_setBodyBS :: OpenAPIRequest req contentType res accept -> B.ByteString -> OpenAPIRequest req contentType res accept
_setBodyBS req body =
    req & L.set (rParamsL . paramsBodyL) (ParamBodyB body)

_setBodyLBS :: OpenAPIRequest req contentType res accept -> BL.ByteString -> OpenAPIRequest req contentType res accept
_setBodyLBS req body =
    req & L.set (rParamsL . paramsBodyL) (ParamBodyBL body)

_hasAuthType :: AuthMethod authMethod => OpenAPIRequest req contentType res accept -> P.Proxy authMethod -> OpenAPIRequest req contentType res accept
...
class P.Typeable a =>
  ...
  applyAuthMethod
    ...
    -> a
    -> OpenAPIRequest req contentType res accept
    -> IO (OpenAPIRequest req contentType res accept)
...
_applyAuthMethods
  ...
  -> OpenAPIConfig
  -> IO (OpenAPIRequest req contentType res accept)
_applyAuthMethods req config@(OpenAPIConfig {configAuthMethods = as}) =
  foldlM go req as
  where
