<?php
/**
 * VersionPackageInfoJavaVersionTest
 *
 * PHP version 8.1.1
 *
 * @category Class
...
use OpenAPI\Server\Model\VersionPackageInfoJavaVersion;
 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\VersionPackageInfoJavaVersion
 */
class VersionPackageInfoJavaVersionTest extends TestCase
{
    protected VersionPackageInfoJavaVersion|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(VersionPackageInfoJavaVersion::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(VersionPackageInfoJavaVersion::class));
        $this->assertInstanceOf(VersionPackageInfoJavaVersion::class, $this->object);
    }
