...
Protected Class DefaultApi
	...
	#tag Method, Flags = &h0
		Sub V1PackagesPackageIdVersionIdJsonGet(, packageId As String, versionId As String)
		  ...
		  Dim localVarPath As String = "/v1/packages/{packageId}/{versionId}.json"
		  
		  Dim localVarPathStringpackageId As String = packageId
		  
		  localVarPath = localVarPath.ReplaceAllB("{packageId}", localVarPathStringpackageId)
		  Dim localVarPathStringversionId As String = versionId
	...
	#tag Property, Flags = &h0
		BasePath As String = "https://launchermeta.mojang.com"
	#tag EndProperty
