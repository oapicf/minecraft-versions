        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services
                .AddSwaggerGen(c =>
                {
                    ...
                    c.SwaggerDoc("1.3.5-pre.0", new OpenApiInfo
                    {
                        ...
                        Contact = new OpenApiContact
                        {
                            ...
                            Url = new Uri("https://github.com/oapicf/minecraft-versions"),
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwagger(c =>
                ...
                .UseSwaggerUI(c =>
                {
                    ...
                    c.SwaggerEndpoint("/openapi/1.3.5-pre.0/openapi.json", "Org.OpenAPITools");

                    //TODO: Or alternatively use the original OpenAPI contract that's included in the static files
                    // c.SwaggerEndpoint("/openapi-original.json", "Org.OpenAPITools Original");
                });
            app.UseRouting();
