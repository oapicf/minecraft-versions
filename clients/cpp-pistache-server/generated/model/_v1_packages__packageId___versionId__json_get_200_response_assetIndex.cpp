...
void _v1_packages__packageId___versionId__json_get_200_response_assetIndex::validate() const
{
...
bool _v1_packages__packageId___versionId__json_get_200_response_assetIndex::validate(std::stringstream& msg) const
{
    return validate(msg, "");
}

bool _v1_packages__packageId___versionId__json_get_200_response_assetIndex::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "_v1_packages__packageId___versionId__json_get_200_response_assetIndex" : pathPrefix;

                        
    return success;
}

bool _v1_packages__packageId___versionId__json_get_200_response_assetIndex::operator==(const _v1_packages__packageId___versionId__json_get_200_response_assetIndex& rhs) const
{
    return
...
void to_json(nlohmann::json& j, const _v1_packages__packageId___versionId__json_get_200_response_assetIndex& o)
{
...
void from_json(const nlohmann::json& j, _v1_packages__packageId___versionId__json_get_200_response_assetIndex& o)
{
    if(j.find("id") != j.end())
    {
...
void _v1_packages__packageId___versionId__json_get_200_response_assetIndex::setId(std::string const& value)
{
    m_Id = value;
    m_IdIsSet = true;
}
...
void _v1_packages__packageId___versionId__json_get_200_response_assetIndex::setSha1(std::string const& value)
{
    m_Sha1 = value;
    m_Sha1IsSet = true;
}
...
void _v1_packages__packageId___versionId__json_get_200_response_assetIndex::setSize(int32_t const value)
{
    m_Size = value;
    m_SizeIsSet = true;
}
...
void _v1_packages__packageId___versionId__json_get_200_response_assetIndex::setTotalSize(int32_t const value)
{
    m_TotalSize = value;
...
void _v1_packages__packageId___versionId__json_get_200_response_assetIndex::setUrl(std::string const& value)
{
    m_Url = value;
    m_UrlIsSet = true;
}
