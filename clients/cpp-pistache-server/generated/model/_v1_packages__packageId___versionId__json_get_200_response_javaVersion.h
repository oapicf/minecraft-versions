...
public:
    ...
    bool operator==(const _v1_packages__packageId___versionId__json_get_200_response_javaVersion& rhs) const;
    bool operator!=(const _v1_packages__packageId___versionId__json_get_200_response_javaVersion& rhs) const;
    ...
    friend  void to_json(nlohmann::json& j, const _v1_packages__packageId___versionId__json_get_200_response_javaVersion& o);
    friend  void from_json(const nlohmann::json& j, _v1_packages__packageId___versionId__json_get_200_response_javaVersion& o);
protected:
