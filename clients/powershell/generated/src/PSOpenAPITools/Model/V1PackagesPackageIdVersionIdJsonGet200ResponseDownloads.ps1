...
V1PackagesPackageIdVersionIdJsonGet200ResponseDownloads<PSCustomObject>
#>

function Initialize-V1PackagesPackageIdVersionIdJsonGet200ResponseDownloads {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => V1PackagesPackageIdVersionIdJsonGet200ResponseDownloads' | Write-Debug
...
Convert from JSON to V1PackagesPackageIdVersionIdJsonGet200ResponseDownloads<PSCustomObject>
...
V1PackagesPackageIdVersionIdJsonGet200ResponseDownloads<PSCustomObject>
#>
function ConvertFrom-JsonToV1PackagesPackageIdVersionIdJsonGet200ResponseDownloads {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => V1PackagesPackageIdVersionIdJsonGet200ResponseDownloads' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V1PackagesPackageIdVersionIdJsonGet200ResponseDownloads
