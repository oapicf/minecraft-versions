...
V1PackagesPackageIdVersionIdJsonGet200Response<PSCustomObject>
#>

function Initialize-V1PackagesPackageIdVersionIdJsonGet200Response {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => V1PackagesPackageIdVersionIdJsonGet200Response' | Write-Debug
...
Convert from JSON to V1PackagesPackageIdVersionIdJsonGet200Response<PSCustomObject>
...
V1PackagesPackageIdVersionIdJsonGet200Response<PSCustomObject>
#>
function ConvertFrom-JsonToV1PackagesPackageIdVersionIdJsonGet200Response {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => V1PackagesPackageIdVersionIdJsonGet200Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in V1PackagesPackageIdVersionIdJsonGet200Response
