...
pplx::task<std::shared_ptr<VersionPackageInfo>> DefaultApi::getMinecraftVersionPackageInfo(utility::string_t packageId, utility::string_t versionId) const
{
    ...
    std::shared_ptr<const ApiConfiguration> localVarApiConfiguration( m_ApiClient->getConfiguration() );
    utility::string_t localVarPath = utility::conversions::to_string_t("/v1/packages/{packageId}/{versionId}.json");
    boost::replace_all(localVarPath, utility::conversions::to_string_t("{") + utility::conversions::to_string_t("packageId") + utility::conversions::to_string_t("}"), web::uri::encode_uri(ApiClient::parameterToString(packageId)));
