...
void _v1_packages__packageId___versionId__json_get_200_response_javaVersion::validate()
{
    // TODO: implement validation
}

web::json::value _v1_packages__packageId___versionId__json_get_200_response_javaVersion::toJson() const
{
...
bool _v1_packages__packageId___versionId__json_get_200_response_javaVersion::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void _v1_packages__packageId___versionId__json_get_200_response_javaVersion::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool _v1_packages__packageId___versionId__json_get_200_response_javaVersion::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t _v1_packages__packageId___versionId__json_get_200_response_javaVersion::getComponent() const
{
    return m_Component;
}

void _v1_packages__packageId___versionId__json_get_200_response_javaVersion::setComponent(const utility::string_t& value)
{
    m_Component = value;
