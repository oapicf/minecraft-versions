...
web::json::value VersionPackageInfo_assetIndex::toJson() const
{
    ...
    if(m_TotalSizeIsSet)
    {
        ...
        val[utility::conversions::to_string_t(_XPLATSTR("totalSize"))] = ModelBase::toJson(m_TotalSize);
    }
    if(m_UrlIsSet)
    {
...
bool VersionPackageInfo_assetIndex::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("totalSize"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(_XPLATSTR("totalSize")));
        if(!fieldValue.is_null())
        {
...
void VersionPackageInfo_assetIndex::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_TotalSizeIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("totalSize")), m_TotalSize));
    }
    if(m_UrlIsSet)
    {
...
bool VersionPackageInfo_assetIndex::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    if(multipart->hasContent(utility::conversions::to_string_t(_XPLATSTR("totalSize"))))
    {
        int32_t refVal_setTotalSize;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(_XPLATSTR("totalSize"))), refVal_setTotalSize );
        setTotalSize(refVal_setTotalSize);
    }
