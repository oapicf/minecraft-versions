...
web::json::value Download::toJson() const
{
    ...
    if(m_Sha1IsSet)
    {
        ...
        val[utility::conversions::to_string_t(_XPLATSTR("sha1"))] = ModelBase::toJson(m_Sha1);
    }
    if(m_SizeIsSet)
    {
...
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("sha1"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(_XPLATSTR("sha1")));
...
void Download::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_Sha1IsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("sha1")), m_Sha1));
    }
    if(m_SizeIsSet)
    {
...
bool Download::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    if(multipart->hasContent(utility::conversions::to_string_t(_XPLATSTR("sha1"))))
    {
        utility::string_t refVal_setSha1;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(_XPLATSTR("sha1"))), refVal_setSha1 );
        setSha1(refVal_setSha1);
    }
