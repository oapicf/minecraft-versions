...
void _v1_packages__packageId___versionId__json_get_200_response_downloads::validate()
{
    // TODO: implement validation
}

web::json::value _v1_packages__packageId___versionId__json_get_200_response_downloads::toJson() const
{
...
bool _v1_packages__packageId___versionId__json_get_200_response_downloads::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("client"))))
    {
        ...
        {
            std::shared_ptr<_v1_packages__packageId___versionId__json_get_200_response_downloads_client> refVal_setClient;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("client_mappings"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<_v1_packages__packageId___versionId__json_get_200_response_downloads_client> refVal_setClientMappings;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("server"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<_v1_packages__packageId___versionId__json_get_200_response_downloads_client> refVal_setServer;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("server_mappings"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<_v1_packages__packageId___versionId__json_get_200_response_downloads_client> refVal_setServerMappings;
...
void _v1_packages__packageId___versionId__json_get_200_response_downloads::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool _v1_packages__packageId___versionId__json_get_200_response_downloads::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
void _v1_packages__packageId___versionId__json_get_200_response_downloads::setClient(const std::shared_ptr<_v1_packages__packageId___versionId__json_get_200_response_downloads_client>& value)
{
    m_Client = value;
    m_ClientIsSet = true;
}
...
void _v1_packages__packageId___versionId__json_get_200_response_downloads::setClientMappings(const std::shared_ptr<_v1_packages__packageId___versionId__json_get_200_response_downloads_client>& value)
{
...
void _v1_packages__packageId___versionId__json_get_200_response_downloads::setServer(const std::shared_ptr<_v1_packages__packageId___versionId__json_get_200_response_downloads_client>& value)
{
    m_Server = value;
    m_ServerIsSet = true;
}
...
void _v1_packages__packageId___versionId__json_get_200_response_downloads::setServerMappings(const std::shared_ptr<_v1_packages__packageId___versionId__json_get_200_response_downloads_client>& value)
{
