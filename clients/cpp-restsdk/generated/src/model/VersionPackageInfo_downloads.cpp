...
web::json::value VersionPackageInfo_downloads::toJson() const
{
    ...
    if(m_Client_mappingsIsSet)
    {
        ...
        val[utility::conversions::to_string_t(_XPLATSTR("client_mappings"))] = ModelBase::toJson(m_Client_mappings);
    }
    if(m_ServerIsSet)
    {
    ...
    if(m_Server_mappingsIsSet)
    {
        ...
        val[utility::conversions::to_string_t(_XPLATSTR("server_mappings"))] = ModelBase::toJson(m_Server_mappings);
    }
...
bool VersionPackageInfo_downloads::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("client_mappings"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(_XPLATSTR("client_mappings")));
        if(!fieldValue.is_null())
        {
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("server_mappings"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(_XPLATSTR("server_mappings")));
        if(!fieldValue.is_null())
        {
...
void VersionPackageInfo_downloads::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_Client_mappingsIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("client_mappings")), m_Client_mappings));
    }
    if(m_ServerIsSet)
    {
    ...
    if(m_Server_mappingsIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("server_mappings")), m_Server_mappings));
    }
}
...
bool VersionPackageInfo_downloads::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    if(multipart->hasContent(utility::conversions::to_string_t(_XPLATSTR("client_mappings"))))
    {
        std::shared_ptr<Download> refVal_setClientMappings;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(_XPLATSTR("client_mappings"))), refVal_setClientMappings );
        setClientMappings(refVal_setClientMappings);
    }
    ...
    if(multipart->hasContent(utility::conversions::to_string_t(_XPLATSTR("server_mappings"))))
    {
        std::shared_ptr<Download> refVal_setServerMappings;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(_XPLATSTR("server_mappings"))), refVal_setServerMappings );
        setServerMappings(refVal_setServerMappings);
    }
    return ok;
}
