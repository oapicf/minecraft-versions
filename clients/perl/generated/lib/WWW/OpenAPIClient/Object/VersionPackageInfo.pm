...
#
package WWW::OpenAPIClient::Object::VersionPackageInfo;
...
__PACKAGE__->method_documentation({
    ...
    'asset_index' => {
        datatype => 'VersionPackageInfoAssetIndex',
        base_name => 'assetIndex',
        description => '',
        format => '',
        read_only => '',
            },
    ...
    'compliance_level' => {
        datatype => 'int',
        base_name => 'complianceLevel',
        description => '',
        format => '',
        read_only => '',
            },
    'downloads' => {
        datatype => 'VersionPackageInfoDownloads',
        base_name => 'downloads',
        description => '',
        format => '',
        read_only => '',
    ...
    'java_version' => {
        datatype => 'VersionPackageInfoJavaVersion',
        base_name => 'javaVersion',
        description => '',
        format => '',
        read_only => '',
            },
    ...
    'minimum_launcher_version' => {
        datatype => 'int',
        base_name => 'minimumLauncherVersion',
        description => '',
        format => '',
        read_only => '',
            },
