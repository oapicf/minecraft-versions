...
OAIVersionPackageInfo_downloads::OAIVersionPackageInfo_downloads(const QString &json) {
...
void OAIVersionPackageInfo_downloads::fromJson(const QString &jsonString) {
