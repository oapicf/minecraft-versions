...
OAIVersionPackageInfo_assetIndex::OAIVersionPackageInfo_assetIndex(const QString &json) {
...
void OAIVersionPackageInfo_assetIndex::fromJson(const QString &jsonString) {
