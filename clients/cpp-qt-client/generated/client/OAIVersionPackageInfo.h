...
namespace OpenAPI {
class OAIVersionPackageInfo_assetIndex;
class OAIVersionPackageInfo_downloads;
class OAIVersionPackageInfo_javaVersion;

class OAIVersionPackageInfo : public OAIObject {
public:
    OAIVersionPackageInfo();
    OAIVersionPackageInfo(const QString &json);
...
private:
    ...
    OAIVersionPackageInfo_assetIndex m_asset_index;
    ...
    OAIVersionPackageInfo_downloads m_downloads;
    ...
    OAIVersionPackageInfo_javaVersion m_java_version;
