...
${BOLD}${WHITE} command line client (API version 1.2.1-pre.0)${OFF}
...
print_about() {
    echo ""
    echo -e "${BOLD}${WHITE} command line client (API version 1.2.1-pre.0)${OFF}"
    echo ""
    echo -e "License: MIT"
...
print_version() {
    echo ""
    echo -e "${BOLD} command line client (API version 1.2.1-pre.0)${OFF}"
    echo ""
}
