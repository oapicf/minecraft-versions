...
void OpenAPIV1PackagesPackageIdVersionIdJsonGet200Response::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIV1PackagesPackageIdVersionIdJsonGet200Response::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
