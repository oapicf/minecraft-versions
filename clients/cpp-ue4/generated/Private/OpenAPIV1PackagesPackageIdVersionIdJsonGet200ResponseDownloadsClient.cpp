...
void OpenAPIV1PackagesPackageIdVersionIdJsonGet200ResponseDownloadsClient::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIV1PackagesPackageIdVersionIdJsonGet200ResponseDownloadsClient::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
