...
void OpenAPIMcGameVersionManifestGet200ResponseVersionsInner::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIMcGameVersionManifestGet200ResponseVersionsInner::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
