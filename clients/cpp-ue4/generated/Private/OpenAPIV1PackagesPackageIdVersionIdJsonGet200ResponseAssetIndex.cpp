...
void OpenAPIV1PackagesPackageIdVersionIdJsonGet200ResponseAssetIndex::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIV1PackagesPackageIdVersionIdJsonGet200ResponseAssetIndex::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
