...
void OpenAPIV1PackagesPackageIdVersionIdJsonGet200ResponseDownloads::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIV1PackagesPackageIdVersionIdJsonGet200ResponseDownloads::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
