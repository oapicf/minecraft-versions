...
- Build date: 2026-08-10T07:12:35.886314145Z[Etc/UTC]
...
```
cargo run --example openapi_client-client GetMinecraftVersionManifest
cargo run --example openapi_client-client GetMinecraftVersionPackageInfo
```
