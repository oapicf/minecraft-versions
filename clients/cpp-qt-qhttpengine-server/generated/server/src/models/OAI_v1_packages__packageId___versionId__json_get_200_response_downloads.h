...
private:
    ...
    OAI_v1_packages__packageId___versionId__json_get_200_response_downloads_client client;
    bool m_client_isSet;
    bool m_client_isValid;

    OAI_v1_packages__packageId___versionId__json_get_200_response_downloads_client client_mappings;
    bool m_client_mappings_isSet;
    bool m_client_mappings_isValid;

    OAI_v1_packages__packageId___versionId__json_get_200_response_downloads_client server;
    bool m_server_isSet;
    bool m_server_isValid;

    OAI_v1_packages__packageId___versionId__json_get_200_response_downloads_client server_mappings;
