...
class McGameVersionManifestGet200ResponseLatest {
    ...
    /**
     * Validates the JSON data with respect to <code>McGameVersionManifestGet200ResponseLatest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>McGameVersionManifestGet200ResponseLatest</code>.
     */
 ...
 */
McGameVersionManifestGet200ResponseLatest.prototype['release'] = undefined;

/**
 * @member {String} snapshot
 */
McGameVersionManifestGet200ResponseLatest.prototype['snapshot'] = undefined;
