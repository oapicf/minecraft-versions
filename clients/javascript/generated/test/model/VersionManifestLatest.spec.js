...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Minecraftversions.VersionManifestLatest();
  });
  ...
  describe('VersionManifestLatest', function() {
    it('should create an instance of VersionManifestLatest', function() {
      ...
      //var instance = new Minecraftversions.VersionManifestLatest();
      //expect(instance).to.be.a(Minecraftversions.VersionManifestLatest);
    });
