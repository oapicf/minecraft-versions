...
Download::Download(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value Download::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void Download::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for Download");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object Download::toJsonObject_internal() const
{
...
void Download::fromJsonObject_internal(boost::json::object const& object)
{
    m_Sha1IsSet = false;
    m_SizeIsSet = false;
    m_UrlIsSet = false;
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<Download>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<Download>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<Download>>>::fromJsonValue(boost::json::parse(json));
}
