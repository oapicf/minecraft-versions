...
Version::Version(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value Version::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void Version::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for Version");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object Version::toJsonObject_internal() const
{
...
void Version::fromJsonObject_internal(boost::json::object const& object)
{
    m_IdIsSet = false;
    m_TypeIsSet = false;
    m_UrlIsSet = false;
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<Version>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<Version>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<Version>>>::fromJsonValue(boost::json::parse(json));
}
