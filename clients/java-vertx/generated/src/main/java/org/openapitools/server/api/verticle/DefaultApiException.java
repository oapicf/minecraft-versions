...
public final class DefaultApiException extends MainApiException {
    ...
    public static final DefaultApiException Default_mcGameVersionManifestGet_200_Exception = new DefaultApiException(200, "A list of Minecraft versions with the latest and snapshot releases");
