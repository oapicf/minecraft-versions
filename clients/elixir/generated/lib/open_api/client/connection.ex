...
defmodule OpenAPI.Client.Connection do
  ...
  @doc """
  Configure a OpenAPI.Client client.

  ### Parameters

  - `options`: an optional keyword list of OpenAPI.Client.Connection.options.
  ...
  def middleware(options \\ []) do
    base_url =
      Keyword.get(
        options,
        :base_url,
        Application.get_env(:"open_api/client", :base_url, @default_base_url)
      )
    ...
    user_agent =
      Keyword.get(
        ...
        Keyword.get(
          tesla_options,
          :user_agent,
          "openapi-generator - OpenAPI.Client 1.0.0 - elixir"
        )
      )
