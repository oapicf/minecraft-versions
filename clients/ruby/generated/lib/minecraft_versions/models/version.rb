  ...
  class Version < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `MinecraftVersionsClient::Version` initialize method"
      end
    ...
    def hash
      [id, type, url, time, release_time].hash
    end
