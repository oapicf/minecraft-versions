...
```shell
gem install ./minecraft_versions-1.1.2-pre.0.gem
```

(for development, run `gem install --dev ./minecraft_versions-1.1.2-pre.0.gem` to install the development dependencies)

or publish the gem to a gem hosting service, e.g. [RubyGems](https://rubygems.org/).

Finally add this to the Gemfile:

    gem 'minecraft_versions', '~> 1.1.2-pre.0'
