...
class DefaultApi(baseUrl: String) {
   ...
   */
  def getMinecraftVersionManifest(): Request[Either[ResponseException[String], VersionManifest]] =
    basicRequest
   ...
   * @param versionId 
   */
  def getMinecraftVersionPackageInfo(packageId: String, versionId: String): Request[Either[ResponseException[String], VersionPackageInfo]] =
    basicRequest
