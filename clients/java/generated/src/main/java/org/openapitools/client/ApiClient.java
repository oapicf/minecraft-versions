...
public class ApiClient {
    ...
    protected String basePath = "https://launchermeta.mojang.com";
    ...
    protected void init() {
        ...
        setUserAgent("OpenAPI-Generator/1.3.5-pre.0/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://launchermeta.mojang.com)
