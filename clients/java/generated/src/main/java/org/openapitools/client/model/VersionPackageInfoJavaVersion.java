...
public class VersionPackageInfoJavaVersion {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("component", "majorVersion"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!VersionPackageInfoJavaVersion.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in VersionPackageInfoJavaVersion is not found in the empty JSON string", VersionPackageInfoJavaVersion.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!VersionPackageInfoJavaVersion.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `VersionPackageInfoJavaVersion` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
